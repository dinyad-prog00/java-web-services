  ...
  <div class="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
    <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
      <div class="sm:max-w-lg">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Les nouvels albums et livres enfin disponibles</h1>
        <p class="mt-4 text-xl text-gray-500">Cette année, notre nouvelle collection d'été vous mettra à l'abri des intempéries d'un monde qui ne se soucie pas de savoir si vous vivez ou mourez.</p>
      </div>
      <div>
        <div class="mt-10">
          ...
          <a href="/ecom/categories" class="inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700">Voir notre selection</a>
        </div>
      </div>
    </div>
  </div>
